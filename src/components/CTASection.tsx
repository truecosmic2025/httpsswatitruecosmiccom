  ...
  return (
    <section className="py-20 px-4 relative overflow-hidden">
      ...
      <div className="container max-w-4xl mx-auto text-center relative z-10">
        ...
        <p className="text-xs text-muted-foreground mb-12">⚡ Limited availability. Most time slots are claimed quickly.</p>

        <div className="bg-card/30 backdrop-blur border border-border/50 rounded-lg p-6 max-w-2xl mx-auto">
          <p className="text-sm text-muted-foreground">
            We care about outcomes and emotional wellbeing. Guidance is gentle, non-judgmental, and tailored to real life. This call is not a substitute for medical or mental-health care; please seek licensed support for those needs.
          </p>
        </div>
      </div>
    </section>
